...
filtered_data1 <- subset(covid_data_count, race != "Total")
ggplot(filtered_data1, aes(x = date, y = Cases, color = race)) +
  geom_point(alpha = 0.5) +
  scale_color_colorblind()

ggplot(covid_data_long, aes(x = date, y = count)) + geom_point()
filtered_data2 <- subset(covid_data_long, race != "Total")
ggplot(filtered_data2, aes(x = date, y = count, color = race)) +
  geom_point(alpha = 0.5) +
  scale_color_colorblind()
...
ggplot(covid_data_race, aes(x = date, y = Total_count, color = count_type)) +
  geom_point(alpha = 0.5) +
  scale_color_colorblind()
```
